...
export const PRODUCTS: Product[] = [
  {
    ...
    description: 'Families, join our small businesses for a scavenger hunt full of riddles, treats, & spooky fun surprises!',
  },
  {
    id: '1',
    ...
    // tslint:disable-next-line:max-line-length
    description: 'Congratulations to all the winners of our 4th of July Raffle! Come on in to Darty’s with your winning ticket to claim your prize of a $10 Darty’s gift card! Reminder: All orders for Candy Grapes are now ready for pickup in store!',
  },
  {
    id: '2,
    ...
    // tslint:disable-next-line:max-line-length
    description: 'Make sure to Stop by Darty’s this week to participate in our 4th of July Raffle!',
  },
  {
    id: '3',
    ...
    // tslint:disable-next-line:max-line-length
    description: 'Come and shop at the Eats & Treats AG pop up shop today. Bring your friends, we will have taste testing, a variety of kid friendly “mock-tails” and an assortment of snacks and goodies!',
},
{
    id: '4',
  ...
  },
  {
    ...
    // tslint:disable-next-line:max-line-length
    description: 'Join us this Friday, 12/10 for a Nacho Night with @eatsandtreatsbyag!',
  },
  {
    id: '7',
